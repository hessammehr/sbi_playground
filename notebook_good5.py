...
def _(LATENT_SITE_NAMES_V3, Predictive, jax, mo, patch_model_v3, random):
    M3_V3_TRAIN_SIZE = 1024
    M3_V3_VAL_SIZE = 256
    M3_V3_BATCH_SIZE = 64
    M3_V3_NUM_STEPS = 600
    M3_V3_EVAL_EVERY = 100
...
def _(
    ...
    M3_V3_TRAIN_EVAL_N = 256
    M3_V3_VAL_EVAL_N = 256
    ...
    heldout_sanity_passed_v3_m3 = bool(
        ...
        and val_metrics_v3_m3["presence_mae"] < 0.18
...
def _(
    ...
    mo.md(
        ...
        **Numerical concerns.** Position, composition, presence, and expected count improve clearly over prior baselines. Size point-estimate recovery is weak/marginal (`size_recovery_concern_v3_m3 = {size_recovery_concern_v3_m3}`), even though the tiny overfit test can recover size. This suggests size is learnable in principle but not yet robustly generalised by the amortised guide/current simulator. Do not hide this in later reports.
        ...
        **Next.** If acceptable despite the size concern, proceed to pseudo-real self-consistency with labels hidden and audited. If size must be stronger before adaptation, improve the renderer/guide/training before moving on.
        """
    )
    return
